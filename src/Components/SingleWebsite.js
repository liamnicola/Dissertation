          ...
          <StyledTable>
            ...
            <tbody>
              <StyledTr>
                <td>Score: {rating}%</td>
                <td>
                  <StyledSpan style={{ color: "green" }}>{upvotes}</StyledSpan>-
                  <StyledSpan style={{ color: "red" }}>{downvotes}</StyledSpan>
                </td>
              </StyledTr>
              <StyledTr>
                <td>
                  <Link to={`/websites`}>Vote Here</Link>
                </td>
                <td>
                  <a href={`https://${w.link}`}>Visit Website </a>
                </td>
              </StyledTr>
            </tbody>
          </StyledTable>
